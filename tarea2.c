...
void buscar_por_genero(Map *cancions_bygeneros) {
  ...
  if (pair != NULL) {
      ...
      Film *cancion = list_first(cancions);
...
int main() {
  ...
  do {
    ...
    case '4':
      ...
      break;
    case '5':
      crear_list_reproduccion();
      break;
    case '6':
      agregar_cancion_aLista();
      break;
    case '7':
      mostrar_list_canciones();
      break;
    }
