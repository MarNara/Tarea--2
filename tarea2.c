...
int main() 
{
  ...
  do // bucle de menú
  {
    ...
    switch(opcion) 
    {
      ...
      case '3':
 //se realiza el buscarliza hacia la funicion buscar_por_artista        limpiarPantalla();
...
// con el 8 se sale
      case '8':
        printf//caso en que le usuario no ingrese la opcion incorrecta("Saliendo del programa...\n");
        break;
      default:
